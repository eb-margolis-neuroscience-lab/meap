...
```{ojs}
//| echo: true
fileAttachArray = [FileAttachment("obs_crossfilter_plots_data/d3_cum_fr_10K_interp_825_12h24m37s.csv"),
...
tx_panel_array = {
  ...
  return [tx_epochs.slice(0,3), tx_epochs.concat(["", ""]).slice(3,5).concat(["Firing Rate"])];
};
```
