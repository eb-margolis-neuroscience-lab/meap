...
experiment <- meapr::load_experiment(
...
plot <- ggplot2::ggplot(
  data = df_long_char,
  mapping = ggplot2::aes(x = unitx, y = unity, fill = acf)) +
  ggplot2::geom_tile(
    color = "white",
    lwd = 0.1,
    linetype = 1) +
  ...
  ggplot2::guides(
    fill = ggplot2::guide_colourbar(
      ...
      barwidth = 10,
      barheight = 1)) +
  ggplot2::ggtitle("Unit Cross-Correlation Heatmap") +
  ggplot2::theme(
...
## Analyze the high correlation pairs
